...
<html>
	<head>
		...
		<link href="${ctx}/assets/css/s.css" type="text/css" rel="stylesheet"></link>
	</head>
	<body>
		<div id="eastLayout" class="easyui-layout" data-options="fit: true">
			...
			<div id="searchHistoryPanel"  data-options="region: 'center',split: true, collapsed: false,   border: false, title: '格式化结果', iconCls: 'icon-standard-application-view-icons'  ">
				...
				<div id="operator" class="panel-header panel-header-noborder  "	style="padding: 5px; height: auto">
					<div>
						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-hamburg-config" plain="true" onclick="Process()">格式化</a>
						<span class="toolbar-item dialog-tool-separator"></span>

						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-redo" plain="true" onclick="clearmess2()">清空</a>
						<span class="toolbar-item dialog-tool-separator"></span>
	...
	<script type = "text/javascript">
		window.SINGLE_TAB = "  ";
		window.ImgCollapsed = "${ctx}/assets/images/Collapsed.gif";
		window.ImgExpanded = "${ctx}/assets/images/Expanded.gif";
