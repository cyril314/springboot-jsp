...
<script type="text/javascript">
	var dg, d, primary_key, selectRowCount = 0;
	var databaseName, addDialog, tableName, NoSQLDbName, add, obj, databaseConfigId;
		...
		dg = $('#dg2').datagrid({
			...
			onDblClickRow: function(rowIndex, rowData) {
				...
				addDialog = $("#dlgg").dialog({
					...
					width: 580,
					height: 360,
					href: '${ctx}/system/permission/i/editNotSqlData/' + key + '/' + NoSQLDbName + '/' + databaseConfigId,
					maximizable: true,
					modal: true,
					buttons: [{
						text: '确认',
